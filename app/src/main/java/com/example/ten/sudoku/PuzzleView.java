...
import static com.example.ten.sudoku.R.color.puzzle_dark;
import static com.example.ten.sudoku.R.color.puzzle_highlight;
import static com.example.ten.sudoku.R.color.puzzle_light;
...
public class PuzzleView extends View {
    ...
    @Override
     protected void onDraw(Canvas canvas) {
        ...
        dark.setColor(getResources().getColor(puzzle_dark));

        Paint highlight = new Paint();
        highlight.setColor(getResources().getColor(puzzle_highlight));

        Paint light = new Paint();
        light.setColor(getResources().getColor(puzzle_light));
